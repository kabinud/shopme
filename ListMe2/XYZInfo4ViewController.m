...
#import "XYZInfo4ViewController.h"

@interface XYZInfo4ViewController ()

@end

@implementation XYZInfo4ViewController
...
- (void)loadTipImageView{
    ...
    UIImage *image = [UIImage imageNamed:@"tips4.png"];
